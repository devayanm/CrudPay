<template>
  <v-container>
    ...
    <v-row>
      ...
      <v-col cols="12" md="6">
        <v-card class="pa-5 mb-4" outlined>
          ...
          <v-card-text>
            <v-text-field
              ...
              dense
            ></v-text-field>
            <v-btn @click="generateQRCode" color="primary" class="mt-2"
            ...
            <v-list v-if="qrCodeHistory.length" class="mt-4">
              ...
              >
                <v-list-item>
                  <v-list-item-content>
                    <v-list-item-title
                      >QR Code {{ index + 1 }}</v-list-item-title
                    >
  ...
  methods: {
    ...
    toggleCamera() {
      this.cameraFacingMode =
        this.cameraFacingMode === "environment" ? "user" : "environment";
      if (this.scanner) {
        this.closeScanner();
        this.openScanner();
      }
